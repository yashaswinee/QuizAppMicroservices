...
public interface QuestionDao extends JpaRepository <Question, Integer>{
    ...
    @Query(value = "SELECT q.id FROM question q WHERE UPPER(q.difficulty)=UPPER(:difficulty) ORDER BY RANDOM() LIMIT :numQ", nativeQuery = true)
    List<Integer> getQuestionsFromId(String difficulty, Integer numQ);
}
